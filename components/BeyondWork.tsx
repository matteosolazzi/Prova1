  ...
  return (
    <FadeIn className="py-20 md:py-32">
      ...
      <div className="flex flex-col gap-8 mb-12">
        <figure>
          <div className="relative w-full overflow-hidden" style={{ aspectRatio: "4/5", maxWidth: "360px", background: "var(--gray-4)" }}>
          ...
          <figcaption className="mt-2 text-sm italic" style={{ color: "var(--gray-1)" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { src: `${BASE}/images/daze.jpg`, alt: "Daze HQ", caption: photos.daze.caption },
            { src: `${BASE}/images/award.jpg`, alt: "German Design Award", caption: photos.award.caption },
            { src: `${BASE}/images/travel.jpg`, alt: "Travel with WeRoad", caption: photos.travel.caption },
          ].map((photo) => (
            <figure key={photo.src}>
              <div className="relative w-full overflow-hidden" style={{ aspectRatio: "4/3", background: "var(--gray-4)" }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={photo.src}
                  alt={photo.alt}
              ...
              <div className="flex flex-col gap-2">
                {cat.items.map((item) => (
                  <div key={item.title} className="flex items-baseline gap-3">
                    ...
                    <span className="text-sm leading-snug flex-shrink-0" style={{ color: "var(--gray-1)" }}>
                      {item.author}
                    </span>
                  </div>
                ))}
